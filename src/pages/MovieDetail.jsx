...
const MovieDetail = () => {
  ...
  return (
    <div className={`flex flex-content justify-center bg-cover bg-center bg-no-repeat h-full dark:bg-gray-700 dark:text-gray-100`} >
      <div className="flex flex-col justify-center items-center w-full h-full ">
      

          {currentMovie &&
        <div className={`flex flex-wrap justify-center gap-3 p-3 min-h-screen dark:bg-gray-700  bg-[url(https://image.tmdb.org/t/p/original/${currentMovie.backdrop_path})]`}>
